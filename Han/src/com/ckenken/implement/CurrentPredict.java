...
//////////////// Q2: find current Location ///////////////////
			...
			IM_Main.SEMANTIC_THRESHOLD = 0.3;
...
//				System.out.println(temp.seqid + "->" + minSymbol);
				...
				if (DataPoint.semantic_cos(temp, testPoint) >= 0.3) {
					q3correct++;	
				}
				else {
					q3fault++;
...
//			System.out.println(temp.seqid + " no sim point!");
	...
	public static DataPoint createTestPoint(int minSymbol) throws SQLException, FileNotFoundException, ParseException
	{
		JDBC jdbc = new JDBC("han");
	...
	public static void nextItem(DataPoint temp, int minSymbol, int qNumber) throws NumberFormatException, SQLException, FileNotFoundException, ParseException
	{	
		JDBC jdbc = new JDBC("han");
		
		System.gc();
		
		String sql = "select * from datapattern_training order by frequent desc limit 5000";
